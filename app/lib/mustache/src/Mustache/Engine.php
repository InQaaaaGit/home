...
class Mustache_Engine
{
     ...
     *
     * @param Mustache_Logger|\moodle\admin\tool\pluginskel\vendor\psr\log\Psr\Log\LoggerInterface $logger
     *@throws Mustache_Exception_InvalidArgumentException If logger is not an instance of Mustache_Logger or Psr\Log\LoggerInterface
     *
     */
    public function setLogger($logger = null)
    {
        if ($logger !== null && !($logger instanceof Mustache_Logger || is_a($logger, 'moodle\\admin\\tool\\pluginskel\\vendor\\psr\\log\\Psr\\Log\\LoggerInterface'))) {
     ...
     *
     * @return Mustache_Logger|\moodle\admin\tool\pluginskel\vendor\psr\log\Psr\Log\LoggerInterface
     */
