/**
 * Инициализация плагина доступности для слабовидящих
 */
define(['jquery', 'local_cdo_visuallyimpaired/bvi-wrapper'], function($, BviWrapper) {
    'use strict';
    ...
    var AccessibilityPlugin = {
        ...
        initializeBVI: function() {
            ...
            BviWrapper.init().then(function(BviClass) {
                try {
                ...
                console.warn('Ошибка загрузки BVI плагина:', error);
                // Показываем простое уведомление пользователю
