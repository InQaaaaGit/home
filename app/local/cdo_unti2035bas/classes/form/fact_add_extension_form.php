...
class fact_add_extension_form extends dynamic_form {
    ...
    public function definition(): void {
        ...
        $usecase = $depends->get_fact_get_unused_extensions_use_case();
        [$this->resultexts, $this->contextexts] = $usecase->execute($factid);
        $this->add_elements();
        $this->set_data([
            'factid' => $factid,
            'notapplicable' => false,
    ...
    public function process_dynamic_submission(): void {
        ...
        $depends = new dependencies();
        $usecase = $depends->get_fact_extension_add_use_case();
        $usecase->execute(
            (int)$factid,
            $extensionname,
    ...
    protected function get_page_url_for_dynamic_submission(): moodle_url {
        return new moodle_url('/local/cdo_unti2035bas/fact_edit.php');
    }
}
