...
$link = "/local/cdo_rpd/management/rpd.php?rpd_id=$rpd_id&edu_plan=$edu_plan&discipline=$discipline";
...
$PAGE->navbar->add(get_string('RPD_my_list', 'local_cdo_rpd'), "/local/cdo_rpd/management/my_list_rpd.php");
        ...
        <div v-if="isDeveloper">
            ...
            <div class="rpd-header">
                ...
                <div class="ml-auto">
                    ...
                    <button class="btn-confirm rpd-header_button" target="_blank">
                        <a class="color-white"
                           :href="`/local/cdo_rpd/rpd/make.php?type=rpd&rpd_id=${INFO.id}&edu_plan=${findGetParameter('edu_plan')}&discipline=${findGetParameter('discipline')}`"
                           target="_blank"
                        >
                            Скачать РПД
                        </a>
                    ...
                    <button class="btn-confirm rpd-header_button" target="_blank">
                        <a class="color-white"
                           :href="`/local/cdo_rpd/rpd/make.php?type=fos&rpd_id=${INFO.id}&edu_plan=${findGetParameter('edu_plan')}&discipline=${findGetParameter('discipline')}`"
                           target="_blank">Скачать ФОС
                        </a>
                    </button>
                    <button class="btn-confirm rpd-header_button" target="_blank">
                        <a class="color-white"
                           :href="`/local/cdo_rpd/rpd/make.php?type=annotation&rpd_id=${INFO.id}&edu_plan=${findGetParameter('edu_plan')}&discipline=${findGetParameter('discipline')}`"
            ...
            <div class="modal-controls import-modal" v-show="globalImportModal">
                ...
                <div class="edit-question-number">
                    Выберете дисциплину для импорта
                </div>
                ...
                <div class="discipline-container">
                    ...
                    <div class="discipline-container__imported">
                        <div class="discipline-container__imported-title">Выберете элементы</div>
