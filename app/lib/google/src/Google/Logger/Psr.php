...
{
  /**
   * @param \moodle\admin\tool\pluginskel\vendor\psr\log\Psr\Log\LoggerInterface $logger The PSR-3 logger
   */
  private $logger;

  /**
   * @param Google_Client $client           The current Google client
   * @param \moodle\admin\tool\pluginskel\vendor\psr\log\Psr\Log\LoggerInterface $logger PSR-3 logger where logging will be delegated.
   */
