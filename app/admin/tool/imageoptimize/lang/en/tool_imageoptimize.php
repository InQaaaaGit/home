...
$string['pdf_converter_token'] = 'pdf_converter_token';
$string['pdf_converter_settings'] = 'pdf_converter_settings';
$string['pdf_max_file_size'] = 'Максимальный размер файла для оптимизации';