...
namespace local_cdo_debts\irbis;
    ...
    function error($code = '')
    {
        ...
        switch ($code) {
            case '0':
                return 'Ошибки нет';
            case '1':
                return 'Подключение к серверу не удалось';
...
// Сохранить запись
    function record_write($record, $lock = false, $if_update = true)
    { // $lock  = блокировать запись , $if_update = актуализировать запись
        $fields = array();
