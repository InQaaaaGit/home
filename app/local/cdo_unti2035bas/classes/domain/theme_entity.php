...
class theme_entity {
    ...
    /** @readonly */
    public int $moduleid;
    public theme_moodle_vo $moodle;
    public theme_unti_vo $unti;
    ...
    public function set_moodledata(theme_moodle_vo $value, int $now): bool {
    ...
    public function set_untidata(theme_unti_vo $value, int $now): bool {
        if ($this->unti == $value) {
            return false;
        }
        $this->unti = $value;
