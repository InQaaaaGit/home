...
class fact_extension_delete extends external_api {
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            'factid' => new external_value(PARAM_INT, 'Fart id'),
    ...
    public static function execute(int $factid, string $extensionname): void {
        ...
        $usecase = $depends->get_fact_extension_delete_use_case();

        $usecase->execute($factid, $extensionname);
    }
}
