...
class SMTP
{
     ...
     * ```
     *
     * @var string|callable|\moodle\admin\tool\pluginskel\vendor\psr\log\Psr\Log\LoggerInterface
     */
    ...
    protected function edebug($str, $level = 0)
    {
        ...
        if ($this->Debugoutput instanceof \moodle\admin\tool\pluginskel\vendor\psr\log\Psr\Log\LoggerInterface) {
