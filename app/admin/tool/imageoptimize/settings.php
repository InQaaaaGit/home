...
if ($hassiteconfig) {
    ...
    $settings->add(new admin_setting_heading(
        'tool_imageoptimize/pdf_converter_settings',
        get_string('pdf_converter_settings', 'tool_imageoptimize'),
        ''
    ));

    $settings->add(new admin_setting_configtext(
        'tool_imageoptimize/pdf_converter_token',
        get_string('pdf_converter_token', 'tool_imageoptimize'),
        '',
        '',
        PARAM_RAW_TRIMMED
    ));
    $settings->add(new admin_setting_configtext(
        'tool_imageoptimize/pdf_max_file_size',
        get_string('pdf_max_file_size', 'tool_imageoptimize'),
        '',
        0,
        PARAM_INT
    ));
