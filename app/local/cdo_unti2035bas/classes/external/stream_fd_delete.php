...
class stream_fd_delete extends external_api {
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            'streamid' => new external_value(PARAM_INT, 'Stream id'),
    ...
    public static function execute(int $streamid, string $extensionname): void {
        ...
        $usecase = $depends->get_stream_fd_delete_use_case();

        $usecase->execute($streamid, $extensionname);
    }
}
