...
class factdef_extensions extends flexible_table implements dynamic_table, renderable, table_out_interface {
    ...
    public function out(?int $pagesize = null, ?bool $initialsbar = null): void {
        ...
        $usecase = $depends->get_factdef_extensions_list_use_case();
        $this->define_headers([
    ...
    protected function col_actions(array $row): string {
        ...
        $delete = new \action_menu_link_primary(
            ...
            get_string('delete'),
            [
                'data-action' => 'factdef-extension-delete',
                'data-factdefid' => $row['factdefid'],
